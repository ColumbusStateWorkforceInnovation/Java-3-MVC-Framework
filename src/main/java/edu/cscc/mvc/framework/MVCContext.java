...
public class MVCContext {
    ...
    private final String qualifyingPackage;
    ...
    public MVCContext() {
        qualifyingPackage = "edu.cscc";
    }

    public MVCContext(String qualifyingPackage) {
        this.qualifyingPackage = qualifyingPackage;
    }
    ...
    public String getQualifyingPackage() {
        return qualifyingPackage;
    }
